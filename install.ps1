<#
	.SYNOPSIS
		Installs the PSAzureMigrationAdvisor Module from github
		
	.DESCRIPTION
		This script installs the PSAzureMigrationAdvisor Module from github.
