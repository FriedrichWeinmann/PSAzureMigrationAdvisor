...
Remove-Module PSAzureMigrationAdvisor -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSAzureMigrationAdvisor.psd1"
Import-Module "$PSScriptRoot\..\PSAzureMigrationAdvisor.psm1" -Force
